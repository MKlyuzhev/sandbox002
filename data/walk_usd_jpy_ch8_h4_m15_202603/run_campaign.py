"""USD_JPY Lien-FX Ch.8 MTF rest-fill walk: H4 bias, M15 entry, Mar–Jun 2026.

Monthly slices keep M15 under the OANDA 5000-bar cap. Research only; no orders.
"""
    ...
    return {
        ...
        "citation": {
            ...
            "claim": (
                ...
                "the trend. H4+M15 is an operator clock, not the book's D+H1 "
                "or shorter-term H1+M15."
            ),
        },
        "note": (
            "Monthly M15 slices (OANDA 5000-bar cap). window_end at slice "
